<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Nivel.aspx.cs" Inherits="Default2" %>
    ...
    <div id="Panel_Grilla">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Listado de nivel</h3>
            </div>
         ...
         function CargarGrilla(data) {
             ...
             var columnas =
                 [
                     ...
                     {
                         "responsive": true, "orderable": true, "mDataProp": "Descrpcion", "defaultContent": '',
                         render: function (data, type, row) { return row.Descrpcion; }
                     },
                     {
